...
import main.dao.CalculateDist;
import main.dto.DataPair;
import main.dto.DataTotal;
import main.dto.InfoPT;
import main.dto.InfoSectionPT;
import main.dto.TimeMethod;

public class ApiPTSearch {
   CalculateDist cd = new CalculateDist();
   StringBuilder sb;
   String key = "5FtIuAS9YmPfOD56TV5NHqYE6EivPWAAIBCZcy6V72c";
   LinkedList<main.dto.Address> ad;
   DataTotal dataTotal;
   ...
   // 생성자, 이차원 배열 초기화
   public ApiPTSearch(LinkedList<main.dto.Address> ad, DataTotal dataTotal, int listSize) {
